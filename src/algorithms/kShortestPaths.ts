...
console.time("Dijkstra Yen K")
for (let i = 0; i < 100000; i++) {
    kShortestPaths(weightedGraph, "1", "4", 3);
}
console.timeEnd("Dijkstra Yen K")

const res = kShortestPaths(weightedGraph, "1", "4", 3);
console.log(res);